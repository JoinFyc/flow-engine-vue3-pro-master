<template>
  <div>
    <el-form-item label="编辑器">
      <el-button @click="visible = true" icon="edit">打开代码编辑器</el-button>
    </el-form-item>
    <w-dialog title="编辑组件代码" v-model="visible" @ok="ok">
      <div class="cp-preview">
        ...
        <div class="cp-render">
          <vue-container v-model="testValue" :mode="mode" :template="modelValue.template" :cp-js="modelValue.cpJs" :cp-style="modelValue.cpStyle"/>
        </div>
        <el-button class="preview" icon="view" @click="doPreview" plain>预览组件</el-button>
      </div>
